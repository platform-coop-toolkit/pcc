...
return [
    ...
    */
    ...
    'colors' => [
        [
            'name' => __('Dark Green', 'platformcoop'),
            'slug' => 'dark-green',
            'color' => '#076431',
        ],
        [
            'name' => __('Green', 'platformcoop'),
            'slug' => 'green',
            'color' => '#0B8441',
        ],
        [
            'name' => __('Light Green', 'platformcoop'),
            'slug' => 'light-green',
            'color' => '#45D385',
        ],
        [
            'name' => __('Pale Green', 'platformcoop'),
            'slug' => 'pale-green',
            'color' => '#C9F8DB',
        ],
        [
            'name' => __('Dark Red', 'platformcoop'),
            'slug' => 'dark-red',
            'color' => '#973102',
        ],
        [
            'name' => __('Red', 'platformcoop'),
            'slug' => 'red',
            'color' => '#FF621A',
        ],
        [
            'name' => __('Light Red', 'platformcoop'),
            'slug' => 'light-red',
            'color' => '#FFA47A',
        ],
        [
            'name' => __('Lighter Red', 'platformcoop'),
            'slug' => 'lighter-red',
            'color' => '#FCC2A7',
        ],
        [
            'name' => __('Pale Red', 'platformcoop'),
            'slug' => 'pale-red',
            'color' => '#FDC2A7',
        ],
        [
            'name' => __('Dark Blue', 'platformcoop'),
            'slug' => 'dark-blue',
            'color' => '#16605D',
        ],
        [
            'name' => __('Blue', 'platformcoop'),
            'slug' => 'blue',
            'color' => '#1D7C79',
        ],
        [
            'name' => __('Light Blue', 'platformcoop'),
            'slug' => 'light-blue',
            'color' => '#30CFC9',
        ],
        [
            'name' => __('Pale Blue', 'platformcoop'),
            'slug' => 'pale-blue',
            'color' => '#C5FDF9',
        ],
        [
            'name' => __('Dark Yellow', 'platformcoop'),
            'slug' => 'dark-yellow',
            'color' => '#E8AA00',
        ],
        [
            'name' => __('Yellow', 'platformcoop'),
            'slug' => 'yellow',
            'color' => '#FACE00',
        ],
        [
            'name' => __('Pale Yellow', 'platformcoop'),
            'slug' => 'pale-yellow',
            'color' => '#FCEEB0',
        ],
        [
            'name' => __('White', 'platformcoop'),
            'slug' => 'white',
            'color' => '#fff',
        ],
        [
            'name' => __('Off White', 'platformcoop'),
            'slug' => 'off-white',
            'color' => '#F9F9F7',
        ],
        [
            'name' => __('Grey', 'platformcoop'),
            'slug' => 'grey',
            'color' => '#707070',
        ],
        [
            'name' => __('Light Grey', 'platformcoop'),
            'slug' => 'light-grey',
            'color' => '#F0EFEF',
        ],
        [
            'name' => __('Dark Mint', 'platformcoop'),
            'slug' => 'dark-mint',
            'color' => '#203131',
        ],
        [
            'name' => __('Dark Mint Light', 'platformcoop'),
            'slug' => 'dark-mint-light',
            'color' => '#294040',
        ],
        [
            'name' => __('Warm Grey', 'platformcoop'),
            'slug' => 'warm-grey',
            'color' => '#585850',
        ],
        [
            'name' => __('Warm Grey Light', 'platformcoop'),
